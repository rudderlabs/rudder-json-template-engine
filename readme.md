...
Versioned URL: https://cdn.jsdelivr.net/npm/@rudderstack/json-template-engine@0.13.3/build/json-template.min.js 

```html
<script type="module">
      import { JsonTemplateEngine } from 'https://cdn.jsdelivr.net/npm/@rudderstack/json-template-engine@0.13.3/build/json-template.min.js';
